...
3. If you are using OCTune - Classic method, there is a bug that causes TDP not to be applied: [download fixed excavator.exe](https://github.com/nicehash/NiceHashQuickMiner/files/6244385/excavator_build818.zip)
