...
**URGENT NOTICE! Power related issue should be gone! If you ever had these issues, try latest version - [download installer and choose v0.4.1.3 RC](https://github.com/nicehash/NiceHashQuickMiner/releases/download/v0.4.1.3/NiceHashQuickMinerInstaller.exe).**
