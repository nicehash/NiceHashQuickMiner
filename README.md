...
**URGENT NOTICE! There is new cool, slick UI for OCTune. Check it out - available in v0.3.1.2 RC and can be downloaded from [here](https://github.com/nicehash/NiceHashQuickMiner/releases/tag/v0.3.1.2_RC).**
