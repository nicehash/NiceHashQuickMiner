...
2. Update NiceHash QuickMiner to [v0.4.6.1](https://github.com/nicehash/NiceHashQuickMiner/releases/tag/v0.4.6.1_RC).

**Did you have issues with Excavator crashing in latest STABLE version? Or do you want to see VRAM temperature for most of cards with GDDR6? [Then download latest RC v0.4.6.1_RC now!](https://github.com/nicehash/NiceHashQuickMiner/releases/download/v0.4.5.5/NiceHashQuickMinerInstaller.exe).**
