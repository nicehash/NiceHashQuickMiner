...
2. Update NiceHash QuickMiner to [v0.4.7.0](https://github.com/nicehash/NiceHashQuickMiner/releases/tag/v0.4.7.0_RC).

**Latest version comes with latest CUDA 11.2 Update 2. Let's hope this fixes issues of some cards having when building DAG. It is very recommended to use latest non-DCH drivers. [Download latest RC v0.4.7.0_RC from here.](https://github.com/nicehash/NiceHashQuickMiner/releases/download/v0.4.5.5/NiceHashQuickMinerInstaller.exe).**
