...
**URGENT NOTICE! NiceHash QuickMiner comes with a fast download-installer - just like modern Browsers are installed. Check it out - available in v0.3.2.0 RC and can be downloaded from [here](https://github.com/nicehash/NiceHashQuickMiner/releases/tag/v0.3.2.0_RC).**
