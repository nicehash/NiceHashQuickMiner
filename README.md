...
**URGENT NOTICE! We have a special-super-duper awesome release this time - it includes UNDERVOLTAGE ability for ALL supported cards. We will shortly write some documentation about it - how to use it. If you can't wait, go ahead - [download installer and choose v0.4.1.1 RC](https://github.com/nicehash/NiceHashQuickMiner/releases/download/v0.4.1.1_INST/NiceHashQuickMinerInstaller.exe).**
